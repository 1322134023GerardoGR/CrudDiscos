...
<br>
            ...
            <div class="page-content">
                <h1>Detalles acerca del artista </h1>
                <div class="row">
                    <div class="col-md-10">
                        <!-- begin::Breadcrumbs -->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ $artists->nombre }}</li>
                            </ol>
                        </nav>
                        <!-- end::Breadcrumbs -->
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="content-box-large">
                                    <div class="panel-body">
                                        ...
                                        <p class="h5">Disco:</p>
                                            @if($discos==null)
                                                <p class="h6 mb-3">No tiene discos</p>
                                            @else
                                                @foreach($discos as $disco)
                                                    <p class="h6 mb-3">{{$disco}}</p>
                                                @endforeach
                                            @endif

                                        <p class="h5">cantantes:</p>
                                        @if($cantantes==null)
                                            <p class="h6 mb-3">No tiene artistas</p>
                                        @else
                                            @foreach($cantantes as $cantante)
                                                <p class="h6 mb-3">{{$cantante}}</p>
                                            @endforeach
                                        @endif
                                    </div>

                                    <a href="{{ route('artist') }}" class="btn btn-warning mt-3">Volver</a>
                                </div>
                                <!-- end::Content -->
                            </div>
                        </div>
