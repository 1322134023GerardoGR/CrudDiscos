                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('store') }}">Discos</a></li>
                            ...
                            <div class="panel-heading">
                                <div class="panel-title"><h2>Artistas</h2></div>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <a href="{{ route('artist.create') }}" class="btn btn-success mt-4 ml-3">Crear</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="v-align-middle">
                                                        <!-- beggin::form for actions -->
                                                         <form action="{{ route('artist.delete',$artist->id) }}"
                                                              method="POST"
