    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="header">
                <div class="container">
                    <br>
                    <h1>Detalles acerca del cantante {{$singers->nombre}} {{$singers->apellidos}}</h1>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="logo">
                                <h5>Rutas</h5>
                    ...
                    <div class="col-md-10">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ $singers->nombre }}</li>
                            </ol>
                        </nav>
                        <!-- end::Breadcrumbs -->
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="content-box-large">
                                    <div class="panel-body">
                                        ...
                                        <p class="h5">Nombre:</p>
                                        <p class="h6 mb-3">{{ $singers->nombre }}</p>

                                        <p class="h5">Apellido:</p>
                                        <p class="h6 mb-3">{{ $singers->apellidos }}</p>

                                        <p class="h5">Fecha de nacimiento:</p>
                                        <p class="h6 mb-3">{{ $singers->fecha_nacimiento }}</p>

                                    </div>

                                    <a href="{{ route('singers') }}" class="btn btn-warning mt-3">Volver</a>
                                </div>
                                <!-- end::Content -->
                            </div>
                        </div>
